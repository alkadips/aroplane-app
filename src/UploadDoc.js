...
function UploadDoc() {
    ...
    return (
        <div>
            ...
            <div onClick={openModal} className='mt-5 border border-black rounded-xl w-[95%] m-auto text-center'>
            ...
            <div onClick={openModal} className='mt-5 border border-black rounded-xl w-[95%] m-auto text-center shadow-xl'>
